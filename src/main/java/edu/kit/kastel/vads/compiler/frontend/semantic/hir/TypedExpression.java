...
public sealed interface TypedExpression permits TypedBinaryOperation, TypedConditionalExpression, TypedIntLiteral, TypedBoolLiteral, TypedUnaryOperation, TypedVariable {
    HirType type();
    Span span();
